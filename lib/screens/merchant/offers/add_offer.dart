                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    FormBuilderDropdown(
                                      name: 'offerCashback',
                                      onChanged: (value) => {
                                        _offerCashbackAmountController.text=value.toString(),
                                        // setState(() {
                                      ...
                                      decoration: InputDecorations
                                          .buildDropdownInputDecoration_1(
                                              hint_text: AppLocalizations.of(context)!.cashback_amount_placeholder),
                                      validator: FormBuilderValidators.compose([
                                        FormBuilderValidators.required(),
                                      ]),
                                    ),
                                  ...
                                  children: [
                                    ...
                                    TextFormField(
                                      controller: _offerComissionAmountController
                                        ..text ='5% ${AppLocalizations.of(context)!.of_bill_amount}',
                                      readOnly: true,
                                      decoration: InputDecorations
                                          .buildInputDecoration_1(
                                              hint_text: ''),
